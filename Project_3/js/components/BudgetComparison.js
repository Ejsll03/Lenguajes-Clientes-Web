export class BudgetComparison {
    ...
    calculateMonthlySummary() {
      ...
      // Filtrar solo los meses que tienen algún valor
      const filteredSummary = {};
      Object.entries(summary).forEach(([monthKey, data]) => {
        if (data.estimated.income > 0 || 
            data.estimated.expense > 0 || 
            data.actual.income > 0 || 
            data.actual.expense > 0) {
          filteredSummary[monthKey] = data;
        }
      });
